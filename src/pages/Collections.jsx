...
const data = [
  ...
  },
  {
    ...
    solutions: "12 راه‌حل",
    description:
      "ابزارهای امنیت سایبری جدید برای محافظت از داده‌ها و سیستم‌های شما.",
    buttonColor: "#009688",
  },
  {
    img: pic5,
    title: "ابزارهای مانیتورینگ شبکه",
    solutions: "18 راه‌حل",
    description: "بهترین ابزارها برای مانیتورینگ و بهینه‌سازی شبکه‌های شما.",
    buttonColor: "#ff9800",
  },
  {
    img: pic6,
